    ...
    <header class="bg-gray-300 h-60">
        ...
        <nav>
           ...
           <ul class="flex items-stretch">
                <li><a href="index.php" class="font-mono text-3xl text-red-800 no-underline m-1.5 drop-shadow-[0_35px_35px_rgba(214,40,57,1)] ">Accueil</li>
...
<input type="text" id="cmdp" name="cmdp" required
    ...
    <footer class="bg-black h-60">
        <ul class="flex items-stretch">
            <li><a href="index.php" class="text-white font-mono text-3xl no-underline m-1.5">Accueil</li>
            <li><a href="index.php" class="text-white font-mono text-3xl no-underline m-1.5">Inscription</li>
            <li><a href="index.php" class="text-white font-mono text-3xl no-underline m-1.5">Connexion</li>
            <li><a href="index.php" class="text-white font-mono text-3xl no-underline m-1.5">Rechercher</li>
        </ul>
